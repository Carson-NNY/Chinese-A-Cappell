            ...
            <div className="container">
              <h1 className="article-title">
                {getText(
                  ...
                  'Echoing through the UN: Columbia University Chinese A Cappella Highlights "Langjiu Lunar New Year Gala"'
                )}
              </h1>
            </div>
          </div>
            ...
            {currentLanguage === "zh" ? (
              <>
                <p>
                  ...
                  Nations Diplomats' Dining Room），参加由郎酒主办的"郎酒新春之夜"。
                </p>
                <p>
                ...
                <div className="article-section-container">
                  <h2 className="article-section-title">独家编曲：一曲《如愿》寄相思</h2>
                  ...
                  <div className="article-highlight-section">
                    <p className="article-highlight article-highlight--body">
                      <strong>层次感：</strong>从开头的静谧叙述到副歌的宏大爆发。
                    </p>
                    <p className="article-highlight article-highlight--body">
                      <strong>情感共鸣：</strong>利用人声模拟乐器的细腻音色，营造出一种温暖而坚定的氛围。
                    </p>
                  </div>
                </div>

                <div className="article-section-container">
                  <h2 className="article-section-title">现场回响：掌声与泪水中的共鸣</h2>
              ...
              <>
                ...
                <div className="article-section-container">
                  <h2 className="article-section-title">Exclusive Arrangement: "Wishing" as a Vessel for Remembrance</h2>
                  <div className="article-section">
                    <div className="article-section-text">
                      <p>
                        For this special evening, we performed a bespoke vocal
                        arrangement of our signature piece, "As You Wish" (如愿),
                        meticulously crafted by our alumnus, Lance Chen.
                      </p>
                      <p>
                        The song serves as a tribute to previous generations while
                        expressing the profound longing that students abroad feel for
                        their homeland and loved ones. To adapt this piece for A
                        Cappella, Lance infused the arrangement with several
                  ...
                  <div className="article-highlight-section">
                    <p className="article-highlight article-highlight--body">
                      ...
                      serene, narrative opening to a grand, powerful explosion in
                      the chorus.
                    </p>
                    <p className="article-highlight article-highlight--body">
                ...
                <div className="article-section-container">
                  <h2 className="article-section-title">Live Resonance: Standing Ovations and Heartfelt Tears</h2>
                  <div className="article-section reverse">
                    <div className="article-section-image">
                      <div className="article-image-wrapper">
                        <img
                    ...
                    <div className="article-section-text">
                      <p>
                        ...
                        Diplomats' Dining Room erupted into thunderous, sustained
                        applause.
                      </p>
                      <p>
                        What moved us most was seeing several fellow Chinese guests in
                        the audience moved to tears. One guest remarked afterward:
                        "Hearing this song at the United Nations, so far from
                        home—especially in such a pure choral form—truly touched the
                  ...
                  <div className="article-highlight-section">
                    <p className="article-highlight article-highlight--no-accent">
                      This sense of connection—of being "worlds apart, yet sharing
                      this moment"—is exactly why we are so passionate about
                      promoting Chinese A Cappella.
                    </p>
                  </div>
                </div>
                ...
                <h2>Conclusion</h2>
                <p>
                  It was a profound honor to be invited to the "Langjiu Lunar
                  ...
                  Columbia University Chinese A Cappella will continue to use our
                  voices to tell China's stories and let the world hear our
                  melody.
                </p>
              </>
            )}
